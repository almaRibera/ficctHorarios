...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-800">Editar Aula: {{ $aula->nombre }}</h1>
            <p class="text-gray-600">Actualice la información del aula</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="piso" id="piso" required
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="1" {{ old('piso', $aula->piso) == '1' ? 'selected' : '' }}>1er Piso</option>
                            <option value="2" {{ old('piso', $aula->piso) == '2' ? 'selected' : '' }}>2do Piso</option>
                            <option value="3" {{ old('piso', $aula->piso) == '3' ? 'selected' : '' }}>3er Piso</option>
                            <option value="4" {{ old('piso', $aula->piso) == '4' ? 'selected' : '' }}>4to Piso</option>
                        </select>
                        @error('piso')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="tipo" id="tipo" required
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="teorica" {{ old('tipo', $aula->tipo) == 'teorica' ? 'selected' : '' }}>Teórica</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="equipamiento" id="equipamiento" rows="3"
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('equipamiento', $aula->equipamiento) }}</textarea>
                        @error('equipamiento')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="observaciones" id="observaciones" rows="3"
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('observaciones', $aula->observaciones) }}</textarea>
                        @error('observaciones')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
